...
class _TrackingPageState extends State<TrackingPage> {
  final List<Location> locations = [
    Location('Mombasa Appartment', DateTime(2022, 6, 5, 5, 23, 4),
        showHour: false, isHere: false, passed: true),
    Location('Syokimau Appartment', DateTime(2022, 6, 6, 5, 23, 4),
        showHour: false, isHere: false, passed: true),
    Location(
      'Kitui Appartment',
  ...
  String selectedProduct = 'Brand windows';
