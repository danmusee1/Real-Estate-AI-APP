...
class CategoryListPageT extends StatefulWidget {
  @override
  _CategoryListPageTState createState() => _CategoryListPageTState();
}

class _CategoryListPageTState extends State<CategoryListPageT> {
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  //  SvgPicture.asset( 'assets/icons/search_icon.svg',fit: BoxFit.scaleDown,)
                ),
                onChanged: (value) {
                  if (value.isNotEmpty) {
