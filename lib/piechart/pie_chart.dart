...
final kCategories = [
  Category('Water', amount: 500.00),
  Category('Electricity', amount: 150.00),
  Category('Caretaker salary', amount: 90.00),
  Category('Maitenance', amount: 90.00),
  Category('Subscriptions', amount: 40.00),
  Category('Repaires', amount: 20.00),
];
